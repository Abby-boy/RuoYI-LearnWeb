  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="orderList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['manage:order:edit']">查看详情</el-button>
        </template>
      </el-table-column>
    </el-table>
...
const { pay_status, pay_type, status } = proxy.useDict('pay_status', 'pay_type', 'status');
