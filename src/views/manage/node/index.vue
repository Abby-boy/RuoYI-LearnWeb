<template>
  <div class="app-container">
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="nodeRef" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="所属区域" prop="regionId">
          <!-- <el-input v-model="form.regionId" placeholder="请选择" /> -->
    ...
    <!-- 查看详情对话框 -->
    <el-dialog title="查看详情" v-model="nodeOpen" width="800px" append-to-body>
      ...
      <el-table-column label="最后一次供货时间" align="center">
        <template #default="scope">
          {{ formatTime(scope.row.lastSupplyTime, 'YYYY-MM-DD HH:mm:ss') }}
        </template>
      </el-table-column>
    </el-table>
    </el-dialog>
