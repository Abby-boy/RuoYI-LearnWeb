    ...
    <el-dialog title="合作商详情" v-model="partnerInfoOpen" width="500px" append-to-body>
        <el-form label-width="120px" label-position="left">
           ...
           <el-form-item label="分成比例">
                  <el-input v-model="form.profitRatio" disabled />
           </el-form-item>
        </el-form>
    </el-dialog>
...
import { listPartner, getPartner, delPartner, addPartner, updatePartner,resetPwd } from "@/api/manage/partner";
...
function reSetPassword(row) {
  ...
  proxy.$modal.confirm('是否确认重置该合作商的密码').then(function() {
    return resetPwd(_id);
  }).then(() => {
    //getList();
